...
loadfileformats = {
    ...
    'dict_of_empty':            {'file':'oneLine', 'data':'dictOfLists', 'header':None},
    ...
    'list_of_lists_empty':      {'file':'oneLine', 'data':'listOfLists', 'header':None},
    'list_of_empty':            {'file':'oneLine', 'data':'listOfEmpty', 'header':None},
